...
## 4 Objectives:
#
# 1.   NB_Mol_Percentage_Yield (% mol NB/MOl C6H6)
# 2.   DNB_Mol_Yield (mol DNB/hr)
# 3.   CO2e  per kg NitroC6h6 (kg CO2/hr)
# 4.   TOTALCOST ($)
...
df = pd.read_csv('NitroBENZENE_4O_pareto2024_11_27_16_23.csv')
